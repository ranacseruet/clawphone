 ...
 *
 * Accepts a config object so it can be driven by either the standalone env-var
 * path (server.mjs) or the OpenClaw plugin path (index.mjs via fromPluginConfig).
 *
