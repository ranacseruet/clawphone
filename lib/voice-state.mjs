...
// key -> { callSid, from, said, reply, done }
const pending = new Map();

// callSid -> key (tracks latest turn per call)
...
export function createPendingTurn({ key, callSid, from, said }) {
  ...
  pending.set(key, { callSid, from, said, done: false, reply: "" });
 ...
 * @returns {Object|undefined} The pending turn or undefined
 */
